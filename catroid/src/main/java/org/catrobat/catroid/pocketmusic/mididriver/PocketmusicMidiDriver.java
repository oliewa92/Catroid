...
public final class PocketmusicMidiDriver implements MidiDriver.OnMidiStartListener {

	private final MidiDriver midiDriver;

	public PocketmusicMidiDriver() {
	...
	public void onMidiStart() {
		sendMidi(MidiSignals.PROGRAM_CHANGE.getSignalByte(), Project.DEFAULT_INSTRUMENT.getInstrumentByte());
		midiDriver.config();
	}
