...
public class MidiRunnable implements Runnable {
	...
	private final PocketmusicMidiDriver midiDriver;

	public MidiRunnable(MidiSignals signal, NoteName noteName, long duration, Handler handler, PocketmusicMidiDriver midiDriver) {
		this.signal = signal;
	...
	@Override
	public void run() {
		midiDriver.sendMidi(signal.getSignalByte(), noteName.getMidi(), 24);
